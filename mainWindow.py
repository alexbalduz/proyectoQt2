...
class Ui_MainWindow(object):
    #Funcion que construye la interfaz grafica con sus respectivos botones y casillas de juego
...
"")
    ...
    #Funcion para marcar las casillas con una X y una O
    ...
    #Funcion para comprobar si hay un ganador, es decir si hay un tres en raya
    def comprobar(self):
    ...
    #Funcion para marcar las casillas y ver si hay un ganador
